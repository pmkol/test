...
git clone https://$github/pmkol/target_linux_rockchip target/linux/rockchip -b linux-6.11
...
if [ "$TESTING_KERNEL" = "y" ]; then
    ...
    git clone https://$github/sbwml/package_kernel_rtl8812au-ct package/kernel/rtl8812au-ct -b openwrt-23.05
    # add rtl8812au-ac
